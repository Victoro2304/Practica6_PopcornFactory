...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas() {
        peliculas.add(Pelicula("Demon Slayer: Kimetsu no Yaiba - To the Hashira Training", R.drawable.demon, R.drawable.demo,
        ...
        peliculas.add(Pelicula("Dune", R.drawable.dune, R.drawable.dune2,
        ...
        peliculas.add(Pelicula("Ghostbusters Apocalipsis", R.drawable.ghostbusters, R.drawable.ghostbusters,
        ...
        peliculas.add(Pelicula("Héroe por Encargo", R.drawable.heroexencargo, R.drawable.heroeencargo,
            "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.",
            arrayListOf<Cliente>()))

        peliculas.add(Pelicula("Madame Web", R.drawable.madameweb, R.drawable.madame,
        ...
        peliculas.add(Pelicula("Vidas Pasadas", R.drawable.vidaspasadas, R.drawable.vidaspasadas1,
    ...
    fun cargarSeries() {
        series.add(Pelicula("Avatar: La Leyenda de Aang", R.drawable.ant, R.drawable.ant,
        ...
        series.add(Pelicula("Halo", R.drawable.halo, R.drawable.halos,
        ...
        series.add(Pelicula("Leveling", R.drawable.sololeveling, R.drawable.sololevelings,
        ...
        series.add(Pelicula("Mi Adorable Demonio", R.drawable.adorabledemonio, R.drawable.adorabledemonios,
        ...
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.elmonstruo, R.drawable.elmonstruovieja,
        ...
        series.add(Pelicula("The Witcher", R.drawable.thewitcher, R.drawable.thewitchers,
